    ...
    def collater(self, samples):
        ...
        for sample in samples:
            ...
            if random.randint(0, 9) == 0:
                not_empty_track_index = torch.nonzero(
                    track_not_empty_bool[:-2]
                )  # can't only keep chord
            ...
            content_num = random.randint(
                1, int(track_not_empty_num / 2) - 1
            )  # chord can not be a content track
            ...
            if content_num != track_not_empty_num:
                ...
                content_combination = it.combinations(
                    not_empty_track_index, content_num
                )
